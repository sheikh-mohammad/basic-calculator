...
**Parameters**:
- `expression` (str): A mathematical expression containing numbers and operators (+, -, *, /, parentheses)

**Returns**:
- `float | int | str`: The calculated result as a number, or an error message as a string starting with "Error:"
...
**Description**: Parses an expression into a list of tokens (numbers and operators).
...
- Handles commands like 'quit' and 'clear'
